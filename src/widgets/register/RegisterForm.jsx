...
import backg from '../../shared/assets/img/image 47.png'; // Импорт изображения фона
    ...
    >
      <form className='bg-[#111120] p-[55px] rounded-[20px] w-[625px] h-[620px] flex flex-col justify-between'>
        ...
        <div className='relative mb-4'>
          <label className='text-white mb-[10px]'>Пароль</label>
          <input 
        ...
        <div className='relative mb-4'>
          <label className='text-white mb-[10px]'>Подтвердите пароль</label>
          <input 
        ...
        <p className='text-white flex justify-center items-center mt-[20px]'>
          У вас есть аккаунт? 
          <span onClick={handleLoginClick} className='text-[#00D1FF] cursor-pointer ml-1'>Войти</span>
        </p>
      </form>
    </div>
  );
