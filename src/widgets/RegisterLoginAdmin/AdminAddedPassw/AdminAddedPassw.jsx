...
function AdminAddedPassw() {
  ...
  return (
    <div className='back-passw m-auto p-[50px] bg-[#111120] mt-[10px] w-[615px] h-[650px] rounded-[20px] text-white '>
...
export default AdminAddedPassw
