...
function adminlogin() {
  ...
  return (
    <div className='bg-[#111120] w-[625px] h-[613px] rounded-[20px] text-white ml-[400px] mt-[15px]'>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="switch-btn flex justify-between items-center" onClick={toggleRememberMe}>
                            ...
                            <div className='tim cursor-pointer'>
                                <h3 className='font-semibold leading-6 text-indigo-400 hover:text-indigo-600'>Забыли пароль?</h3>
                            </div>
                        </div>

                        <div>
                            <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm font-semibold leading-6 ">Sign in</button>
                        </div>
                    </form>
                    <p className="mt-10 text-center text-gray-500">
                        у вас нет аккаунта? { }
                        <a href="#" className="font-semibold leading-6 text-indigo-400 hover:text-indigo-600">Зарегистрироваться</a>
                    </p>
                </div>
            </div>
        </div>
